...
#set_property -dict { PACKAGE_PIN AD21 IOSTANDARD  LVCMOS18 } [get_ports { data_in[0] }];# Bank  13 VCCO - VCCO_1V8 - IO_L13N_T2_MRCC_13 sw12-b0
#set_property -dict { PACKAGE_PIN AF22 IOSTANDARD  LVCMOS18 } [get_ports { data_in[1] }];# Bank  13 VCCO - VCCO_1V8 - IO_L23N_T3_13 -sw12-b1
#set_property -dict { PACKAGE_PIN AE22 IOSTANDARD  LVCMOS18 } [get_ports { data_in[2] }];# Bank  13 VCCO - VCCO_1V8 - IO_L19P_T3_13 -sw12 -b2
#set_property -dict { PACKAGE_PIN AE23 IOSTANDARD  LVCMOS18 } [get_ports { data_in[3] }];# Bank  13 VCCO - VCCO_1V8 - IO_L19N_T3_VREF_13 -sw12 -b3
#set_property -dict { PACKAGE_PIN AF25 IOSTANDARD  LVCMOS18 } [get_ports { data_in[4] }];# Bank  13 VCCO - VCCO_1V8 - IO_25_13 -sw12 -b4
#set_property -dict { PACKAGE_PIN AE25 IOSTANDARD  LVCMOS18 } [get_ports { data_in[5] }];# Bank  13 VCCO - VCCO_1V8 - IO_L20P_T3_13 -sw12 -b5
#set_property -dict { PACKAGE_PIN AD25 IOSTANDARD  LVCMOS18 } [get_ports { data_in[6] }];# Bank  13 VCCO - VCCO_1V8 - IO_L15P_T2_DQS_13 -sw12 -b6
#set_property -dict { PACKAGE_PIN AC24 IOSTANDARD  LVCMOS18 } [get_ports { data_in[7] }];# Bank  13 VCCO - VCCO_1V8 - IO_L10P_T1_13 -sw12 -b7
set_property -dict { PACKAGE_PIN AC23 IOSTANDARD  LVCMOS18 } [get_ports { data_in[0] }];# Bank  13 VCCO - VCCO_1V8 - IO_L9N_T1_DQS_13-sw10 -b8 1.
set_property -dict { PACKAGE_PIN AD23 IOSTANDARD  LVCMOS18 } [get_ports { data_in[1] }];# Bank  13 VCCO - VCCO_1V8 - IO_L14P_T2_SRCC_13 -sw10 -b9 2.
set_property -dict { PACKAGE_PIN AC21 IOSTANDARD  LVCMOS18 } [get_ports { data_in[2] }];# Bank  13 VCCO - VCCO_1V8 - IO_L8N_T1_13-sw10 -b10  3.
set_property -dict { PACKAGE_PIN AB21 IOSTANDARD  LVCMOS18 } [get_ports { data_in[3] }];# Bank  13 VCCO - VCCO_1V8 - IO_L4P_T0_13-sw10 -b11
set_property -dict { PACKAGE_PIN AA19 IOSTANDARD  LVCMOS18 } [get_ports { data_in[4] }];# Bank  13 VCCO - VCCO_1V8 - IO_L1N_T0_13-sw10 -b12
set_property -dict { PACKAGE_PIN AB19 IOSTANDARD  LVCMOS18 } [get_ports { data_in[5] }];# Bank  13 VCCO - VCCO_1V8 - IO_L3P_T0_DQS_13-sw10 -b13
set_property -dict { PACKAGE_PIN AE17 IOSTANDARD  LVCMOS18 } [get_ports { data_in[6] }];# Bank  13 VCCO - VCCO_1V8 - IO_L17P_T2_13-sw10 -b14
set_property -dict { PACKAGE_PIN AF15 IOSTANDARD  LVCMOS18 } [get_ports { data_in[7] }];# Bank  13 VCCO - VCCO_1V8 - IO_L21P_T3_DQS_13-sw10 -b15



################################################## LEDS 
#set_property -dict { PACKAGE_PIN AF24 IOSTANDARD  LVCMOS18 } [get_ports "DSI_LED_EN"];# Bank  13 VCCO - VCCO_1V8 - IO_L24N_T3_13
set_property -dict { PACKAGE_PIN J25 IOSTANDARD  LVCMOS33 } [get_ports {tx_done}];# Bank  15 VCCO - VCCO_3V3 - IO_L16N_T2_15
#set_property -dict { PACKAGE_PIN M24 IOSTANDARD  LVCMOS33 } [get_ports {counter[1]}];# Bank  15 VCCO - VCCO_3V3 - IO_L24N_T3_RS0_15
#set_property -dict { PACKAGE_PIN L24 IOSTANDARD  LVCMOS33 } [get_ports {counter[2]}];# Bank  15 VCCO - VCCO_3V3 - IO_L22P_T3_15
#set_property -dict { PACKAGE_PIN K25 IOSTANDARD  LVCMOS33 } [get_ports {counter[3]}];# Bank  15 VCCO - VCCO_3V3 - IO_L19N_T3_VREF_15
#set_property -dict { PACKAGE_PIN K26 IOSTANDARD  LVCMOS33 } [get_ports {counter[4]}];# Bank  15 VCCO - VCCO_3V3 - IO_L20P_T3_15
#set_property -dict { PACKAGE_PIN M25 IOSTANDARD  LVCMOS33 } [get_ports {counter[5]} ];# Bank  15 VCCO - VCCO_3V3 - IO_25_15
...
################################################## GPIO SWITCHES 
set_property -dict { PACKAGE_PIN AA20 IOSTANDARD  LVCMOS18 } [get_ports {tx_start_in}];# Bank  13 VCCO - VCCO_1V8 - IO_L2P_T0_13
#set_property -dict { PACKAGE_PIN AB20 IOSTANDARD  LVCMOS18 } [get_ports {datain}];# Bank  13 VCCO - VCCO_1V8 - IO_L3N_T0_DQS_13
...
set_property -dict { PACKAGE_PIN Y21 IOSTANDARD  LVCMOS33 } [get_ports {tx_out}];# Bank  14 VCCO - VCCO_3V3 - IO_L21P_T3_DQS_14
#set_property -dict { PACKAGE_PIN Y22 IOSTANDARD  LVCMOS33 } [get_ports {tx_out}];# Bank  14 VCCO - VCCO_3V3 - IO_L21N_T3_DQS_D22_14
